...
\begin{figure}
  ...
  \begin{subfigure}[b]{0.32\textwidth}
    \centering
    \includegraphics[width=\textwidth]{{Figures/Schkade2010/BoulderCivilUnions_latentMean=10_tol=0.1}.pdf}
  \end{subfigure}
  \begin{subfigure}[b]{0.32\textwidth}
    \centering
    \includegraphics[width=\textwidth]{{Figures/Schkade2010/COSpringsCivilUnions_latentMean=2_tol=0.1}.pdf}
  \end{subfigure}
...
\subsection{Case study 1: Schkade, et al., 2010}

\begin{figure}[h]
  \centering
  \begin{subfigure}[b]{0.32\textwidth}
    \centering
    \includegraphics[width=\textwidth]{{Figures/Schkade2010/BoulderGlobalWarming_latentMean=10_tol=0.05}.pdf}
  \end{subfigure}
  \begin{subfigure}[b]{0.32\textwidth}
    \centering
    \includegraphics[width=\textwidth]{{Figures/Schkade2010/BoulderCivilUnions_latentMean=10_tol=0.05}.pdf}
  \end{subfigure}
  \begin{subfigure}[b]{0.32\textwidth}
    \centering
    \includegraphics[width=\textwidth]{{Figures/Schkade2010/COSpringsCivilUnions_latentMean=2_tol=0.05}.pdf}
  \end{subfigure}
  \caption{Success rate of recreating reported group opinions and opinion
    shifts for different latent parameter combinations. Further parameter
    combination examples---lower tolerance and other latent mean---are (WILL BE) given in
    the supplement.}
    \label{fig:successHeatmapsSupplement}
\end{figure}
...
\begin{figure}
  ...
  \begin{subfigure}[b]{0.3\textwidth}
    \centering
    \includegraphics[width=\textwidth]{{Figures/Schkade2010/BoulderGlobalWarming_latentMean=9.8_tol=0.1}.pdf} \\
    \includegraphics[width=\textwidth]{{Figures/Schkade2010/BoulderGlobalWarming_latentMean=10_tol=0.1}.pdf} \\
    \includegraphics[width=\textwidth]{{Figures/Schkade2010/BoulderGlobalWarming_latentMean=10.2_tol=0.1}.pdf} 
  \end{subfigure}
  \begin{subfigure}[b]{0.3\textwidth}
    \centering
    \includegraphics[width=\textwidth]{{Figures/Schkade2010/BoulderCivilUnions_latentMean=9.8_tol=0.1}.pdf} \\
    \includegraphics[width=\textwidth]{{Figures/Schkade2010/BoulderCivilUnions_latentMean=10_tol=0.1}.pdf} \\
    \includegraphics[width=\textwidth]{{Figures/Schkade2010/BoulderCivilUnions_latentMean=10.2_tol=0.1}.pdf} 
  \end{subfigure}
  \begin{subfigure}[b]{0.3\textwidth}
    \centering
    \includegraphics[width=\textwidth]{{Figures/Schkade2010/COSpringsCivilUnions_latentMean=1.9_tol=0.1}.pdf} \\
    \includegraphics[width=\textwidth]{{Figures/Schkade2010/COSpringsCivilUnions_latentMean=2_tol=0.1}.pdf} \\
    \includegraphics[width=\textwidth]{{Figures/Schkade2010/COSpringsCivilUnions_latentMean=2.1_tol=0.1}.pdf} \\
  \end{subfigure}
  \caption{Success rate of recreating reported group opinions and opinion
    shifts for different latent parameter combinations. Further parameter
    combination examples---lower tolerance and other latent mean---are (WILL BE) given in
